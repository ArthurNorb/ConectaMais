        ...
        <div class="grid grid-cols-1 gap-8">
            <div class="flex flex-col">
                <div class="flex flex-col items-center sm:flex-row">
                    <h2 class="mr-auto text-lg font-semibold text-themeColor">Editar Contato</h2>
                ...
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    @if (
                        $errors->has('rua') ||
                            ...
                            $errors->has('cep'))
                        <p class="text-xs text-red-500">Se preencher um campo do endereço, todos devem ser preenchidos.
                        </p>
                    @endif
