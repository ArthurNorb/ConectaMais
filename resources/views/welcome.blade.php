        ...
        <div class="relative w-full max-w-5xl px-4 sm:px-6 lg:px-8">
            @auth
                ...
                <ul role="list" class="grid grid-cols-1 gap-6 mt-12 sm:grid-cols-2">
                            ...
                            <a href="{{ route('contatos.edit', $contato->id) }}">
                                <div class="flex items-center justify-between w-full p-6 space-x-6">
                                    <div class="flex-1 truncate">
                                        ...
                                        @if ($contato->rua)
                                            <p class="mt-1 text-sm truncate text-themeColorLight">
                                                <b>Endereço:</b> {{ $contato->rua }}, {{ $contato->numero }},
                                                {{ $contato->cidade }},
                    ...
                    @empty
                        <li class="flex justify-center col-span-1 sm:col-span-2">
                            <div class="flex flex-col items-center max-w-lg text-center">
                                <h1 class="text-3xl font-semibold text-themeColor">
                                    Você ainda não possui nenhum contato
                                </h1>
                                <p class="mt-4 text-lg text-gray-500">
                                    Clique no botão abaixo para adicionar seu primeiro contato
                                </p>
                ...
                <div class="items-center justify-center">
                    <div class="py-32 mx-auto text-center">
                        ...
                        <p class="mt-8 text-lg font-medium text-gray-500 sm:text-xl">
                            Com o Conecta+, todos seus contatos estão sempre ao seu alcance. Simplifique sua vida
                            unindo todas as suas conexões em um só lugar.
                        </p>
